...
class RoutesTest extends TestCase
{
    ...
    {
        $response = $this->get(route('laravel-log-viewer::dashboard'));
    ...
    {
        $response = $this->get(route('laravel-log-viewer::logs.list'));
        $response->assertSuccessful();
    ...
    public function it_can_show_a_log_page(): void
    {
        ...
        $response = $this->get(route('laravel-log-viewer::logs.show', [$date]));
        $response->assertSuccessful();
    ...
    public function it_can_see_a_filtered_log_entries_page(): void
    {
        ...
        $response = $this->get(route('laravel-log-viewer::logs.filter', [$date, $level]));
        $response->assertSuccessful();
    ...
    public function it_can_search_if_log_entries_contains_same_header_page(): void
    {
        ...
        $response = $this->get(route('laravel-log-viewer::logs.search', compact('date', 'level', 'query')));
        $response->assertSuccessful();
    ...
    public function it_must_redirect_if_search_query_is_not_available(): void
    {
        ...
        $this->get(route('laravel-log-viewer::logs.search', compact('date', 'level')))
             ->assertRedirect(route('laravel-log-viewer::logs.show', [$date]));
    }
    ...
    public function it_can_download_a_log_page(): void
    {
        ...
        $response = $this->get(route('laravel-log-viewer::logs.download', [$date]));
        $response->assertSuccessful();
    ...
    public function it_can_delete_a_log(): void
    {
        ...
        $response = $this->call('DELETE', route('laravel-log-viewer::logs.delete', compact('date')), [], [], [], ['HTTP_X-Requested-With' => 'XMLHttpRequest']);
    ...
    {
        $response = $this->get(route('laravel-log-viewer::logs.show', ['0000-00-00']));
    ...
    {
        $response = $this->delete(route('laravel-log-viewer::logs.delete'), ['date' => '0000-00-00'], ['HTTP_X-Requested-With' => 'XMLHttpRequest']);

        static::assertInstanceOf(Webmonks\LaraLogViewer\Exceptions\FilesystemException::class, $response->exception);
    ...
    {
        $response = $this->delete(route('laravel-log-viewer::logs.delete'));
