...
class PublishCommandTest extends TestCase
{
    ...
    {
        $this->artisan('laravel-log-viewer:publish')
             ->assertExitCode(0);
    ...
    {
        $this->artisan('laravel-log-viewer:publish', ['--force'   => true])
             ->assertExitCode(0);
    ...
    {
        $this->artisan('laravel-log-viewer:publish', ['--tag' => 'config'])
             ->assertExitCode(0);
    ...
    {
        $this->artisan('laravel-log-viewer:publish', ['--tag' => $tag])
             ->assertExitCode(0);
    ...
    public function providePublishableTranslationsTags(): array
    {
        return [
            ['translations'],
            ['laravel-log-viewer-translations'],
        ];
    }
    ...
    {
        return $this->getConfigPath().'/laravel-log-viewer.php';
    }
    ...
    {
        return realpath(base_path().'/resources/lang/vendor/laravel-log-viewer');
    }
