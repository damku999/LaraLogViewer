...
use Webmonks\LaraLogViewer\Utilities\LogChecker;
...
class LogCheckerTest extends TestCase
{
    ...
    /** @var  Webmonks\LaraLogViewer\Utilities\LogChecker */
    private $checker;
    ...
    protected function setUp(): void
    {
        ...
        $this->checker = $this->app->make(Webmonks\LaraLogViewer\Contracts\Utilities\LogChecker::class);
    }
