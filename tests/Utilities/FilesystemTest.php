...
use Webmonks\LaraLogViewer\Utilities\Filesystem;
...
class FilesystemTest extends TestCase
{
    ...
    /** @var  Webmonks\LaraLogViewer\Utilities\Filesystem */
    private $filesystem;
    ...
    {
        $this->expectException(Webmonks\LaraLogViewer\Exceptions\FilesystemException::class);
