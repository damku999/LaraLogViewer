...
use Webmonks\LaraLogViewer\Utilities\Factory;
...
class FactoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->logFactory = $this->app->make(Webmonks\LaraLogViewer\Contracts\Utilities\Factory::class);
    }
    ...
    {
        $expectations = [
            Webmonks\LaraLogViewer\Contracts\Utilities\Filesystem::class,
            Webmonks\LaraLogViewer\Utilities\Filesystem::class,
        ];
    ...
    {
        $expectations = [
            Webmonks\LaraLogViewer\Contracts\Utilities\LogLevels::class,
            Webmonks\LaraLogViewer\Utilities\LogLevels::class,
        ];
    ...
    public function it_can_get_all_logs(): void
    {
        ...
        static::assertInstanceOf(Webmonks\LaraLogViewer\Entities\LogCollection::class, $logs);
    ...
    {
        $this->expectException(Webmonks\LaraLogViewer\Exceptions\LogNotFoundException::class);
