...
use Webmonks\LaraLogViewer\Contracts\Utilities\Filesystem;
...
use Webmonks\LaraLogViewer\Helpers\LogParser;
use Webmonks\LaraLogViewer\LaraLogViewerServiceProvider;
use Webmonks\LaraLogViewer\Providers\DeferredServicesProvider;
use Carbon\Carbon;
...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function getEnvironmentSetUp($app): void
    {
        ...
        $config->set('laravel-log-viewer.storage-path', $app['path.storage'].DIRECTORY_SEPARATOR.'logs');
    }
     ...
     *
     * @param  string                                            $date
     * @param  Webmonks\LaraLogViewer\Entities\LogEntryCollection  $entries
     */
     ...
     *
     * @param  string                                  $date
     * @param  Webmonks\LaraLogViewer\Entities\LogEntry  $entry
     */
     ...
     *
     * @return Webmonks\LaraLogViewer\Utilities\Filesystem
     */
