...
return [
    ...
    'route'         => [
        ...
        'attributes' => [
            'prefix'     => 'laravel-log-viewer',

            'middleware' => env('Darshan Baraiya_LOGVIEWER_MIDDLEWARE') ? explode(',', env('Darshan Baraiya_LOGVIEWER_MIDDLEWARE')) : null,
        ],
    ],
    ...
    'menu'  => [
        'filter-route'  => 'laravel-log-viewer::logs.filter',
