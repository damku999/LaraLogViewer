...
## Guidelines
  ...
  * **Translations :**
    * After you made your translations, ensure that you added your locale key in alphabetical order at [line](https://github.com/damku999/LaraLogViewer/master/tests/TestCase.php#L29) in the `tests/TestCase.php` file for the tests.
