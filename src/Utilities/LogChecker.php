...
class LogChecker implements LogCheckerContract
{
     ...
     * Refresh the checks.
     *
     * @return \Webmonks\LaraLogViewer\Utilities\LogChecker
     */
    ...
    private function checkHandler()
    {
        ...
        $this->messages['handler'] = 'You should set the log handler to `daily` mode. Please check the LaraLogViewer wiki page (Requirements) for more details.';
    }
