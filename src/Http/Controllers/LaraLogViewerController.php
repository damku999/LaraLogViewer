...
namespace Webmonks\LaraLogViewer\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator;use Illuminate\Routing\Controller;
use Illuminate\Support\Arr;
use Illuminate\Support\Collection;
use Illuminate\Support\Str;
use Webmonks\LaraLogViewer\Contracts\LaraLogViewer as LaraLogViewerContract;
use Webmonks\LaraLogViewer\Entities\LogEntry;
use Webmonks\LaraLogViewer\Entities\LogEntryCollection;
use Webmonks\LaraLogViewer\Exceptions\LogNotFoundException;
use Webmonks\LaraLogViewer\Tables\StatsTable;

/**
 * Class     LaraLogViewerController
 *
 * @author   Darshan Baraiya <webmonks.in@gmail.com>
 */
class LaraLogViewerController extends Controller
{
    /* -----------------------------------------------------------------
    |  Properties
    | -----------------------------------------------------------------
    ...
    /** @var string */
    protected $showRoute = 'laravel-log-viewer::logs.show';
    ...
    /**
     * LaraLogViewerController constructor.
     *
    ...
    public function __construct(LaraLogViewerContract $logViewer)
    {
        ...
        $this->perPage = config('laravel-log-viewer.per-page', $this->perPage);
    }
    ...
    {
        $theme = config('laravel-log-viewer.theme');

        return view()->make("laravel-log-viewer::{$theme}.{$view}", $data, $mergeData);
    }
     ...
     * @param  string  $date
     *
     * @return \Webmonks\LaraLogViewer\Entities\Log|null
     */
