            ...
            <tbody>
                @forelse($rows as $date => $row)
                    <tr>
                        ...
                        @endforeach
                        <td class="text-right">
                            <a href="{{ route('laravel-log-viewer::logs.show', [$date]) }}" class="btn btn-sm btn-info">
                                <i class="fa fa-search"></i>
                            </a>
                            <a href="{{ route('laravel-log-viewer::logs.download', [$date]) }}" class="btn btn-sm btn-success">
