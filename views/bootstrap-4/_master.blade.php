...
<head>
    ...
    <meta name="description" content="LaraLogViewer">
    <meta name="author" content="Darshan Baraiya">
    <title>LaraLogViewer - Created by Darshan Baraiya</title>
    {{-- Styles --}}
...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <a href="{{ route('laravel-log-viewer::dashboard') }}" class="navbar-brand mr-0">
            <i class="fa fa-fw fa-book"></i> LaraLogViewer
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item {{ Route::is('laravel-log-viewer::dashboard') ? 'active' : '' }}">
                    <a href="{{ route('laravel-log-viewer::dashboard') }}" class="nav-link">
                        <i class="fa fa-dashboard"></i> @lang('Dashboard')
                    </a>
                </li>
                <li class="nav-item {{ Route::is('laravel-log-viewer::logs.list') ? 'active' : '' }}">
                    <a href="{{ route('laravel-log-viewer::logs.list') }}" class="nav-link">
    ...
    <footer class="main-footer">
        <div class="container-fluid">
            <p class="text-muted pull-left">
                LaraLogViewer - <span class="badge badge-info">version {{ log_viewer()->version() }}</span>
            </p>
            <p class="text-muted pull-right">
                Created with <i class="fa fa-heart"></i> by Darshan Baraiya <sup>&copy;</sup>
            </p>
        </div>
    </footer>
