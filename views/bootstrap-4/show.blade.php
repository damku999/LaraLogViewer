...
@extends('laravel-log-viewer::bootstrap-4._master')
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <div class="group-btns pull-right">
                        <a href="{{ route('laravel-log-viewer::logs.download', [$log->date]) }}" class="btn btn-sm btn-success">
                ...
                <div class="card-footer">
                    {{-- Search --}}
                    <form action="{{ route('laravel-log-viewer::logs.search', [$log->date, $level]) }}" method="GET">
                        <div class="form-group">
                            <div class="input-group">
                                <input id="query" name="query" class="form-control" value="{{ $query }}" placeholder="@lang('Type here to search')">
                                <div class="input-group-append">
                                    @unless (is_null($query))
                                        <a href="{{ route('laravel-log-viewer::logs.show', [$log->date]) }}" class="btn btn-secondary">
                    ...
                    <table id="entries" class="table mb-0">
                        ...
                        <tbody>
                            @forelse($entries as $key => $entry)
                                <?php /** @var  Webmonks\LaraLogViewer\Entities\LogEntry  $entry */ ?>
                                <tr>
                                    <td>
...
@section('modals')
    ...
    <div id="delete-log-modal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <form id="delete-log-form" action="{{ route('laravel-log-viewer::logs.delete') }}" method="POST">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.result === 'success') {
                            ...
                            location.replace("{{ route('laravel-log-viewer::logs.list') }}");
                        }
                        else {
