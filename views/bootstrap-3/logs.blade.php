                    ...
                    <tr>
                        @foreach($row as $key => $value)
                            <td class="{{ $key == 'date' ? 'text-left' : 'text-center' }}">
                                ...
                                @else
                                    <a href="{{ route('laravel-log-viewer::logs.filter', [$date, $key]) }}">
                        ...
                        @endforeach
                        <td class="text-right">
                            <a href="{{ route('laravel-log-viewer::logs.show', [$date]) }}" class="btn btn-xs btn-info">
                                <i class="fa fa-search"></i>
                            </a>
                            <a href="{{ route('laravel-log-viewer::logs.download', [$date]) }}" class="btn btn-xs btn-success">
                ...
                @empty
                    <tr>
                        <td colspan="11" class="text-center">
                            <span class="label label-default">{{ trans('laravel-log-viewer::general.empty-logs') }}</span>
                        </td>
                    </tr>
                @endforelse
            </tbody>
