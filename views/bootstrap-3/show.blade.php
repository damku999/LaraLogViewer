...
@extends('laravel-log-viewer::bootstrap-3._master')
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="group-btns pull-right">
                        <a href="{{ route('laravel-log-viewer::logs.download', [$log->date]) }}" class="btn btn-xs btn-success">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    @unless (is_null($query))
                                        <a href="{{ route('laravel-log-viewer::logs.show', [$log->date]) }}" class="btn btn-default">
