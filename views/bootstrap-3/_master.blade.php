    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="{{ route('laravel-log-viewer::dashboard') }}" class="navbar-brand">
                    <i class="fa fa-fw fa-book"></i> LaraLogViewer
                </a>
            </div>
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav">
                    <li class="{{ Route::is('laravel-log-viewer::dashboard') ? 'active' : '' }}">
                        <a href="{{ route('laravel-log-viewer::dashboard') }}">
                            <i class="fa fa-dashboard"></i> @lang('Dashboard')
                        </a>
                    </li>
                    <li class="{{ Route::is('laravel-log-viewer::logs.list') ? 'active' : '' }}">
                        <a href="{{ route('laravel-log-viewer::logs.list') }}">
    ...
    <footer class="main-footer">
        <div class="container">
            <p class="text-muted pull-left">
                LaraLogViewer - <span class="label label-info">version {{ log_viewer()->version() }}</span>
            </p>
